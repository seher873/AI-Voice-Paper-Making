  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-sm sm:text-base font-semibold text-slate-800">Paper Header</h2>
      </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 bg-white border border-slate-200 rounded-lg text-xs sm:text-sm text-slate-600 hover:border-indigo-400 hover:text-indigo-600 transition-all"
              >
                ...
                <>
                  <div className="flex items-center gap-2">
                    {logoError ? (
                      ...
                      <img src={state.schoolLogo} alt="Preview" className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg object-cover border border-slate-200" />
                    )}
                  </div>
                  <button
