      ...
      >
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 px-5 py-4 flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => setMenuOpen(false)}
              className="lg:hidden ml-auto min-h-[44px] min-w-[44px] flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-all rounded-xl"
